...
model = dict(
    ...
    neck_3d=dict(
        ...
        stride=2,
        is_transpose=False,
        fuse=dict(in_channels=64 * seq_times * 6 * 3, out_channels=256),  # c*seq*h*fpn_lvl
        norm_cfg=dict(type='BN', requires_grad=True)),
    bbox_head=dict(
...
data = dict(
    ...
    train=dict(
        ...
        test_mode=False,
        box_type_3d='LiDAR',
        ann_file='data/nuscenes/pkl/nuscenes_infos_train_4d_interval3_max60.pkl',
        load_interval=1,
        sequential=need_sequential,
        n_times=4,
        train_adj_ids=[1, 3, 5],
        speed_mode='abs_velo',
        max_interval=10,
    ...
    val=dict(
        ...
        test_mode=True,
        box_type_3d='LiDAR',
        ann_file='data/nuscenes/pkl/nuscenes_infos_val_4d_interval3_max60.pkl',
        load_interval=1,
        sequential=need_sequential,
        n_times=4,
        train_adj_ids=[1, 3, 5],
...
evaluation = dict(interval=4, start=20, pipeline=test_pipeline)
